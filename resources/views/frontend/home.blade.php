            ...
            <div class="events-slider swiper" data-aos="fade-up" data-aos-delay="100">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="row event-item">
                            ...
                            <div class="col-lg-6 pt-4 pt-lg-0 content">
                                ...
                                <p class="fst-italic">
                                    “Disparitas kemiskinan memang masih tinggi. Oleh karena itu, diskusi yang interaktif
                                    dan positif di antara kita diharapkan jadi solusi pembangunan” ucap Kepala BPS,
                                    Kecuk Suhariyanto ketika menjadi pembicara kunci dalam acara “Kegiatan Konsultasi
                                    Regional PDRB Sulampua 2019” yang bertemakan “Mendorong Pertumbuhan Ekonomi Wilayah
                                    Sulampua yang Berkeadilan dan Berkelanjutan melalui Peningkatan Daya Saing dan
                                    Pemanfaatan Sumber Daya Unggulan Daerah”.
                                </p>
                                <!-- <ul>
                        ...
                        <li><i class="bi bi-check-circled"></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat.</li>
                                ...
                                <p>
                                    Dalam sambutannya, Dominggus menjelaskan bahwa untuk mendukung keberhasilan program
                                    pembangunan daerah harus memanfaatkan data statistik. Hal ini penting untuk
                                    mewujudkan impian Papua Barat menjadi provinsi konservasi alam. Setiap usaha
                                    peningkatan perekonomian memang selayaknya berasaskan berkelanjutan agar menghindari
                                    pencemaran dan kerusakan lingkungan di Papua. “Kita jaga alam, alam jaga kita. Kita
                                    jaga hutan, hutan jaga kita,” tutur Dominggus.
                                </p>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="row event-item">
                            ...
                            <div class="col-lg-6 pt-4 pt-lg-0 content">
                                ...
                                <p class="fst-italic">
                                    “Rekomendasi dan pemikiran yang dihasilkan dalam Rapat Koordinasi Regional Produk
                                    Domestik Regional Bruto se-Kalimantan diharapkan dapat menjadi masukan dalam
                                    merumuskan arah kebijakan pembangunan ekonomi Indonesia, khususnya Regional
                                    Kalimantan”, demikian kiranya disampaikan Gubernur Kalimantan Timur Dr. Ir. H. Isran
                                    Noor, M.Si dalam acara Rapat Koordinasi Regional Produk Domestik Regional Bruto
                                    se-Kalimantan di Kota Balikpapan yang diselenggarakan Badan Perencanaan Pembangunan
                                    Daerah Provinsi Kalimantan Timur bekerjasama dengan Badan Pusat Statistik Provinsi
                                    Kalimantan Timur.
                                </p>
                                <!-- <ul>
                        <li><i class="bi bi-check-circled"></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat.</li>
                        ...
                        <li><i class="bi bi-check-circled"></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat.</li>
                                ...
                                <p>
                                    Acara ini dihadiri oleh 400 orang peserta terdiri dari Kepala Badan Pusat Statistik
                                    (BPS) Republik Indonesia, Kepala Bappeda Provinsi se Kalimantan, Kepala BPS Provinsi
                                    se Kalimantan, Kepala Bappeda Kabupaten/Kota se Kalimantan dan Kepala BPS
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="row event-item">
                            ...
                            <div class="col-lg-6 pt-4 pt-lg-0 content">
                                ...
                                <p class="fst-italic">
                                    Pada Hari, Selasa 7 Februari 2023. Bappeda Prov. Sultra menyelenggarakan Rapat
                                    Rancangan Rencana Pembangunan Daerah Prov. Sultra Tahun 2024-2026 (Finalisasi
                                    Tujuan, Sasaran, Strategi dan Arah Kebijakan Pembangunan Daerah Serta Program
                                    Perangkat Daerah) yang dilaksanakan di Hotel Azizah Syariah Kendari.
                                </p>
                                <!-- <ul>
                    <li><i class="bi bi-check-circled"></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat.</li>
                    <li><i class="bi bi-check-circled"></i> Duis aute irure dolor in reprehenderit in voluptate velit.</li>
                    <li><i class="bi bi-check-circled"></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat.</li>
                                ...
                                <p>
                                    Kegiatan ini bertujuan untuk mendiskusikan Tujuan, Sasaran, Strategi dan Arah
                                    Kebijakan Pembangunan Daerah Serta Program Perangkat Daerah dengan seluruh OPD
                                        ...
                                        <tbody>
                                            @foreach ($socialTables as $key => $value)
                                                <tr>
                                                    ...
                                                    @endphp
                                                    <td>
                                                        <a href={{ route('frontend.show', ['category' => 'sosial', 'value' => $value]) }}>
                                                            {{ $nama_file }}
                                                        </a>
                                                    </td>
                                                    <td>{{ $tahun }}</td>
                                        ...
                                        <tbody>
                                            @foreach ($economyTables as $key => $value)
                                                <tr>
                                                    ...
                                                    @endphp
                                                    <td>
                                                    <a href=<?php echo "'" ."./detail-statistik.php?kategori=ekonomi&nama_file=".$value."'"; ?> >
                                                        <?= $nama_file; ?></a>
                                                    </td>
                                                    <td>{{ $tahun }}</td>
                                                </tr>
                                        ...
                                        <tbody>
                                            @foreach ($agricultureTables as $key => $value)
                                                <tr>
                                                    ...
                                                    @endphp
                                                    <td>
                                                        <a href=<?php echo "'" ."./detail-statistik.php?kategori=pertanian&nama_file=".$value."'"; ?> >
                                                            <?= $nama_file; ?></a>
                                                    </td>
                                                    <td>{{ $tahun }}</td>
                                                </tr>
                ...
                <div class="col-lg-2 col-md-6">
                    <div class="buku" data-aos="zoom-in" data-aos-delay="100">
                        ...
                        <div class="buku-info">
                            ...
                            <div class="social">
                                <a target="_blank"
                                    href="https://sultra.bps.go.id/publication.html?Publikasi%5BtahunJudul%5D=&Publikasi%5BkataKunci%5D=Statistik+Penduduk+Lanjut+Usia+Sulawesi+Tenggara&Publikasi%5BcekJudul%5D=0&yt0=Tampilkan"
                                    class="btn">Unduh</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-2 col-md-6">
                    <div class="buku" data-aos="zoom-in" data-aos-delay="200">
                        ...
                        <div class="buku-info">
                            ...
                            <div class="social">
                                <a target="_blank"
                                    href="https://sultra.bps.go.id/publication.html?Publikasi%5BtahunJudul%5D=2023&Publikasi%5BkataKunci%5D=sulawesi+tenggara+dalam+angka&Publikasi%5BcekJudul%5D=0&yt0=Tampilkan"
                                    class="btn">Unduh</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-2 col-md-6">
                    <div class="buku" data-aos="zoom-in" data-aos-delay="300">
                        ...
                        <div class="buku-info">
                            ...
                            <div class="social">
                                <a target="_blank"
                                    href="https://sultra.bps.go.id/publication.html?Publikasi%5BtahunJudul%5D=2022&Publikasi%5BkataKunci%5D=sulawesi+tenggara+dalam+infografis&Publikasi%5BcekJudul%5D=0&Publikasi%5BcekJudul%5D=1&yt0=Tampilkan"
                                    class="btn">Unduh</a>
                            </div>
                        </div>
                    </div>
