<!-- ======= Top Bar ======= -->
<div id="topbar" class="d-flex align-items-center fixed-top" @if (!request()->routeIs('frontend.home'))
    style="background-color: black" @endif>
...
<!-- Start Header -->
<header id="header" class="fixed-top d-flex align-items-center" @if (!request()->routeIs('frontend.home'))
    style="background-color: black" @endif>
