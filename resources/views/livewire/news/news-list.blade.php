<div>
    <main id="main" class="main">
        <div class="d-flex pagetitle justify-content-between mb-3 align-items-center">
            ...
            <a wire:navigate href="{{ route('backend.news.create') }}" class="btn" style="background-color: #012970">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-between">
                                    <a wire:navigate href="{{ route('backend.news.edit', $newsItem->id) }}" class="btn btn-primary">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <button
                                        wire:click="$set('newsId', {{ $newsItem->id }})"
    ...
    <x-inputs.confirmation-modal message="Apakah anda ingin menghapus berita ini ?" />
</div>
