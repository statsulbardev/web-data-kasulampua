<footer id="footer">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="footer-info">
                <a href="https://sulbar.bps.go.id" class="logo me-auto me-lg-0"><img src="assets/img/logobps.svg" alt="" class="img-fluid"  style="margin-bottom: 15px;"></a>
                <p>
                ...
                <div class="social-links mt-3">
                  <a href="https://facebook.com/bpssulbar" class="facebook"><i class="bx bxl-facebook"></i></a>
                  <a href="https://instagram.com/bpssulbar" class="instagram"><i class="bx bxl-instagram"></i></a>
                  <a href="https://www.youtube.com/BPSProvinsiSulawesiBarat" class="youtube"><i class="bx bxl-youtube"></i></a>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="copyright">
          <span id="currentYear"></span> &copy; <strong><span>BPS Provinsi Sulawesi Tenggara</span></strong>. Semua Hak Dilindungi
        </div>
      </div>
    </footer><!-- End Footer -->
